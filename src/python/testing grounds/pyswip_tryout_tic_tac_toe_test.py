...
import pyswip_tryout_tic_tac_toe
...
class TestPySwipTicTacToe(unittest.TestCase):
    ...
    def test_end_of_game(self):
        board = ['x','x','o',
                 'o','o','x',
                 'x','o','o']
        legal_moves = pyswip_tryout_tic_tac_toe.get_legal_moves(board)
        game_end, winner = pyswip_tryout_tic_tac_toe.check_game_state(board, legal_moves)
