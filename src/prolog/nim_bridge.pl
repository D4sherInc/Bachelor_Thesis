...
action_to_string(0, 0, "1 takes 1") :- !.
action_to_string(0, 1, "1 takes 2") :- !.
action_to_string(0, 2, "1 takes 3") :- !.
action_to_string(1, 0, "2 takes 1") :- !.
action_to_string(1, 1, "2 takes 2") :- !.
action_to_string(1, 2, "2 takes 3").
% -----------------------------------------------------------------------------------------
% internal predicates
